...
export default function Testimonials() {
  return (
    ...
    <section className='-skew-y-1'>
      ...
      <div className='flex gap-6 -ml-12 -mt-16 relative z-30'>
        <div>
          <div className='w-96 bg-[#B3E6FF] pt-10 pb-14 text-center px-16 border-black border-b-[16px]'>
            <p className='text-[#333333] text-xl font-manrope font-medium'>The praise you hear from your fans feels good, but it doesn’t explain why your sales won’t grow. Feedback products just like yours.</p>
          </div>
          <img src={Testimonial} alt="Testimonial" width={100} height={100} className='absolute ml-36 -mt-12'/>
