    ...
    return (
        <div className='py-20 bg-[#345EC9]'>
            <div className='border border-white w-[874px] py-8 mx-auto'>
                ...
                <p className='text-white text-sm font-manrope font-normal'>Professional Info</p>
                <p className='text-[#ffffff80] text-sm font-manrope font-normal'>Qualifications</p>
                <p className='text-[#ffffff80] text-sm font-manrope font-normal pl-2'>Contact & Shipment</p>
        ...
        <div className='border border-white mx-auto w-[874px] px-14 py-20'>
            ...
            <button className='text-[#345EC9] text-base font-manrope font-semibold bg-white px-11 py-3 rounded-3xl'><Link to='/evaluator-page-3'>Next</Link></button>
        </div>
    </div>
    );
}
