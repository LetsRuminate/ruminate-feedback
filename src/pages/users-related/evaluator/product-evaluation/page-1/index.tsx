...
export default function EvaluationPage1() {
    return (
        <div className='py-20 bg-[#345EC9]'>
            <div className='border border-white w-[874px] py-8 mx-auto'>
                ...
                <p className='text-[#ffffff80] text-sm font-manrope font-normal -ml-3'>Unboxing</p>
        ...
        <div className='border border-white mx-auto w-[874px] px-14 py-20'>
            <button className='text-white text-base font-manrope font-medium rounded-3xl border border-white px-9 py-3 mr-5'><Link to='/evaluation-default'>Previous</Link></button>
            <button className='text-[#345EC9] text-base font-manrope font-semibold bg-white px-11 py-3 rounded-3xl'><Link to='/evaluation-page-2'>Next</Link></button>
        </div>
    </div>
    );
}
